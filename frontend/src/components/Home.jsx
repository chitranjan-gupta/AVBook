...
function Home() {
  ...
  return (
    <div>
      <div className="extra">
        <h1>
          moviesdawnload.<b className="th">com</b>
        </h1>
        <span>
          <b className="wh">moviesdawnload.</b>
          <b className="th">com</b> is among the best website for sharing movies
          and shows for free
        </span>
        ...
        <div className="link-container">
          ...
          <a
            ...
            href="https://www.meetup.com/find/?keywords=movies4u"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24.607"
          ...
          <a
            className="circle-link"
            title="Join on Discord For Latest Updates"
            href="https://discord.gg/moviesdawnload.com"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="26"
      ...
      <footer className="copyright">
        <div>
          <a className="disclaimer" href="disclaimer">
            {" "}
            Copyright © 2021 — moviesdawnload.<b className="th">com</b>. All
            Rights Reserved. Free Movies & TV Shows by moviesdawnload.
            <b className="th">com</b>. Disclaimer:- moviesdawnload.
            <b className="th">com</b> does not host any files on it's servers.
            All files or contents hosted on third party websites.
            moviesdawnload.<b className="th">com</b> does not accept
